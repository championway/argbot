...
class SUBT_detection():
	def __init__(self):
		...
		self.net.load_weights('/home/arg_ws3/argbot/catkin_ws/src/classify/src/subt_3000.pth')
		if torch.cuda.is_available():
			self.net = self.net.cuda()

		#img = cv2.imread("radio.jpg")
		self.image_pub = rospy.Publisher("/predict_img", Image, queue_size = 1)
		self.image_sub = rospy.Subscriber("/X1/rgbd_camera/rgb/image_raw", Image, self.img_cb, queue_size=1, buff_size = 2**24)
		#self.predict(img)
